package it.gov.pagopa.taxonomy.config;
...
public class LoggingAspect {
  ...
  @Pointcut("execution(* it.gov.pagopa.taxonomy.repository..*.*(..))")
  public void repository() {
    // all repository methods
  }

  @Pointcut("execution(* it.gov.pagopa.taxonomy.service..*.*(..))")
  public void service() {
    // all service methods
  }

  @Pointcut("execution(* it.gov.pagopa.taxonomy.exception.ErrorHandler.*(..))")
